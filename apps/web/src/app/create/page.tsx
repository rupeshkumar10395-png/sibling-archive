      ...
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        main {
          ...
          margin: 0 auto;
          padding: clamp(54px, 8vw, 100px) 0 55px;
        }
        ...
        .tape {
          ...
          height: 34px;
          background: var(--tape);
          filter: drop-shadow(0 2px 2px rgba(80, 50, 20, 0.07));
          opacity: 0.8;
        }
        .tape.top {
          top: -17px;
        ...
        .photo {
          ...
          background: #fffdf8;
          box-shadow: 0 20px 34px rgba(40, 30, 18, 0.15), 0 2px 5px rgba(40, 30, 18, 0.06);
          z-index: 1;
        ...
        .photo .scene img {
          ...
          display: block;
          object-fit: cover;
          filter: saturate(0.86) contrast(0.94) sepia(0.05);
        }
        .photo .scene:after {
          content: "";
          position: absolute;
          inset: 0;
          background: linear-gradient(180deg, rgba(255, 255, 255, 0.08), transparent 45%, rgba(25, 18, 10, 0.08));
          pointer-events: none;
        }
        .photo .caption {
          position: absolute;
        ...
        .form-wrap {
          ...
          position: relative;
          z-index: 5;
          border-top: 1px dashed rgba(29, 27, 24, 0.17);
          padding-top: 38px;
        }
        .form-layout {
          display: grid;
        ...
        .input {
          width: 100%;
          height: 72px;
          border: 1px solid rgba(29, 27, 24, 0.27);
          border-radius: 10px;
          padding: 0 20px;
        ...
        .input:focus {
          ...
          background: #fffdf8;
          box-shadow: 0 0 0 4px rgba(239, 90, 76, 0.09);
        }
        .hint {
          margin: 12px 0 0;
          color: #716b63;
        ...
        .create {
          ...
          gap: 17px;
          box-shadow: 4px 4px 0 rgba(29, 27, 24, 0.14);
          transition: transform 0.2s, box-shadow 0.2s, background 0.2s;
        }
        .create:hover {
          transform: translate(-2px, -2px);
          box-shadow: 6px 6px 0 rgba(29, 27, 24, 0.14);
        }
        .create:active {
          transform: translate(0, 0);
          box-shadow: 2px 2px 0 rgba(29, 27, 24, 0.14);
        }
        .create:disabled {
          cursor: wait;
          opacity: 0.75;
        ...
        .note {
          ...
          min-height: 132px;
          box-shadow: 4px 8px 15px rgba(70, 40, 35, 0.13);
        ...
        .note:before {
          ...
          background: rgba(225, 191, 126, 0.53);
        }
        .note p {
          margin: 0;
          font-family: "Caveat", "Bradley Hand", cursive;
        ...
        .feature {
          ...
          gap: 15px;
          align-items: start;
          border-right: 1px dashed rgba(29, 27, 24, 0.2);
        }
        ...
        .status.loading .status-box, .status.success .status-box, .status.error .status-box {
          display: flex;
          align-items: center;
          gap: 11px;
        }
        ...
        .spinner {
          width: 17px;
          height: 17px;
          border: 2px solid rgba(29, 27, 24, 0.18);
        ...
        .success-card h2 {
          font: 600 45px/1 "Bodoni Moda", Georgia, serif;
        ...
        .success-card .hand-note {
          font: 500 20px/1 "Caveat", "Bradley Hand", cursive;
          color: var(--coral);
          transform: rotate(-2deg);
          margin-top: 18px;
        }
        ...
        .form-panel {
          ...
          box-shadow: 0 10px 24px rgba(40, 30, 18, 0.055);
        }
